...
export const StrokeAnimation: React.FC = () => {
	...
	if (phase == 0) {
		...
		whiteX = interpolate(frame, phaseRange, [40, 0], {
			easing: Easing.inOut(Easing.sin),
		});
		whiteY = 0;
		greenX = interpolate(frame, phaseRange, [0, 40], {
			easing: Easing.inOut(Easing.sin),
		});
		greenY = 40;
		fillOpacity = 0;
	...
	if (phase == 1) {
		...
		whiteY = interpolate(frame, phaseRange, [0, 40], {
			easing: Easing.inOut(Easing.sin),
		});
		greenY = interpolate(frame, phaseRange, [40, 0], {
			easing: Easing.inOut(Easing.sin),
		});
	}
	if (phase == 3) {
	...
	return (
        ...
        paddingRight: '20px',
				...
				<svg width="150" height="74" fill="none" viewBox="-1 -1 354 75">
					<path
						stroke="#fff"
						style={{
